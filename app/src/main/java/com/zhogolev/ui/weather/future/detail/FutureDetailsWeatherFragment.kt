...
import com.zhogolev.data.db.LocalDateConverter
import com.zhogolev.internal.DateNotFoundException
...
class FutureDetailsWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    private val viewModelFactoryInstanceFactory: ((LocalDate) -> FutureDetailModelFactory) by factory()
    ...
    private fun bindUI() = launch(Dispatchers.Main) {
        ...
        futureWeather.observe(this@FutureDetailsWeatherFragment, Observer { weatherEntry ->
            ...
            updatePrecipitation(weatherEntry.totalPrecepitation)
            ...
            GlideApp.with(this@FutureDetailsWeatherFragment)
                .load("http:" + weatherEntry.conditionURL)
